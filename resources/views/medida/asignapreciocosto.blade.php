...
@include('medida/modaleditaritem')
<div class="container">
  ...
  <div class="justify-content-center">
    ...
    @include('medida/modalasignacion')
    <div class="card">
  <div class="card-header" style="background-color: #f3bb53">
    <h3 >Precio costo por presentacion</h3>
...
function asignarp(e) {
  ...
  function editar(id_presentacionprecio){ 
     ...
     $.ajax({url:'obteneritem/'+idetallepp}).done(function(data){
         console.log(data);
         $('#presentacion').val(data[0].nombremedida);
         $('#precio').val(data[0].precio_costo);
         $('#iditem').val(data[0].id);
